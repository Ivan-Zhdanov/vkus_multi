...
count = 0
for url_1 in urls_list[104:110]:  # Иду по urls сайта беру первый урл в списке всех урлов сайта
    ...
    try:
        ...
        # **************************************************
        # ВЫВОД ТОГО С ЧЕМ БУДЕМ РАБОТАТЬ
        print('ДЛИНА -->', len(h2_text_img_new_clear))
        i = 0
        for hti in h2_text_img_new_clear:
            i = i + 1
            print(i, '----------', hti)
